...
bkz. kullanıcı hafızası "referans sistem screen inventory") ve **YAPILMAZ değil** (reddedilmiş bir
...
- **Kanıt:** K2=%0 (0/6, `RentTo`/`Ofis_Durum` kavramları bizde tanımsız), K3=%7 (2/27, yalnız
  ...
  partneri) kod tabanında `grep`'le bulunamadı. Canlı başlığı jenerik "referans sistem".
