...
> kontrolünü ve sorumlulukları özetler. referans sistem paritesi gereği export'lar PII içerir (TC/telefon/maaş); bu bilinçli
...
### Özet (yönetim için)
RentACar export'ları, referans sistem'teki gibi kişisel veri içerir; ancak **rol-bazlı erişim (ticari=ViewReports,
