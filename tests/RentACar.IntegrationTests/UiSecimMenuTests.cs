...
public sealed class UiSecimMenuTests(WebFixture fx)
{
    ...
    public async Task Menu_rol_ve_izne_gore_suzulur()
    {
        ...
        foreach (var r in new[] { "/app/panel", "/app/kiralar/yeni", "/app/araclar", "/app/araclar/detayli", "/app/cariler", "/app/crm", "/app/hukuk", "/kasa", "/app/raporlar/karlilik", "/app/raporlar/personel-calisma", "/app/tarife-aktar", "/app/servisler", "/app/regulasyon", "/app/maliyet-teklifleri", "/app/ayarlar", "/app/vade", "/app/bildirimler", "/app/markalar", "/app/subeler", "/app/blog-yonetim" })
        ...
        Assert.Equal(110, ogeler.Count(e => e.GetProperty("sahip").GetString() == "spa"));
        ...
        foreach (var r in new[] { "/app/araclar/detayli", "/app/musteri-taksit", "/vehicles", "/app/crm", "/crm", "/maliyet-hesapla", "/app/maliyet-hesapla", "/app/maliyet-teklifleri", "/tarife-aktar", "/app/tarife-aktar", "/vade", "/servisler", "/kasa", "/kurlar", "/app/raporlar/gunluk", "/app/raporlar/personel-calisma", "/app/ayarlar", "/app/subeler", "/app/personel", "/app/belge-sablonlari", "/app/ice-aktar" })
            Assert.DoesNotContain(r, op);

        var (muh, _) = await MenuAsync(await GirisAsync(o, Kim.Muhasebe));
        foreach (var r in new[] { "/app/panel", "/kasa", "/faturalar", "/app/raporlar/gunluk", "/app/raporlar/kasa-banka", "/app/araclar/detayli", "/app/crm", "/app/maliyet-hesapla", "/app/maliyet-teklifleri", "/app/musteri-taksit", "/app/vade" })
            Assert.Contains(r, muh);
        foreach (var r in new[] { "/app/kiralar/yeni", "/app/kiralar", "/app/araclar", "/vehicles", "/raporlar/gunluk", "/app/cariler", "/cariler", "/tarife-aktar", "/app/tarife-aktar", "/app/tarifeler", "/app/servisler", "/app/ayarlar", "/app/markalar", "/markalar" })
    ...
    public async Task Menu_kullanici_bazli_istisna_ve_modul_bayragini_uygular()
    {
        ...
        // Modül açık: 110 + Web Sitesi grubu 4 = 114 spa öğe.
        Assert.Equal(114, govde.GetProperty("ogeler").EnumerateArray().Count(e => e.GetProperty("sahip").GetString() == "spa"));
