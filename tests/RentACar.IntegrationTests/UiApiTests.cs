...
public sealed class UiApiTests(WebFixture fx)
{
        ...
        string firma = "yucerent", string kullanici = "umit", WebFactory? f = null)
    {
        ...
        var r = await c.SendAsync(Istek(HttpMethod.Post, Giris, once, new { firma, kullanici, sifre = "***REMOVED***" }));
    ...
    public async Task Giris_oturum_cerezi_ve_taze_xsrf_verir_ben_doner()
    {
        ...
        var once = await XsrfAl(c);
        var r = await c.SendAsync(Istek(HttpMethod.Post, Giris, once, new { firma = "yucerent", kullanici = "umit", sifre = "***REMOVED***" }));
    ...
    public async Task Cikis_oturumu_kapatir_belirteci_yeniler()
    {
        ...
        var eski = await c.SendAsync(Istek(HttpMethod.Post, Giris, sonra, new { firma = "yucerent", kullanici = "umit", sifre = "***REMOVED***" }));
        await ProblemBekle(eski, HttpStatusCode.BadRequest, "xsrf_gecersiz");
        var yeni = await c.SendAsync(Istek(HttpMethod.Post, Giris, cikisSonrasi, new { firma = "yucerent", kullanici = "umit", sifre = "***REMOVED***" }));
    ...
    public async Task Giris_de_csrf_ister()
    {
        ...
        var r = await c.SendAsync(Istek(HttpMethod.Post, Giris, null, new { firma = "yucerent", kullanici = "umit", sifre = "***REMOVED***" }));
    ...
    {
        var yeni = await ApiSeed.TenantUserAsync(fx.Pg.OwnerConnectionString, "pilotac", "umit", "***REMOVED***");
    ...
    {
        var id = await ApiSeed.TenantUserAsync(fx.Pg.OwnerConnectionString, "kapanacak", "umit", "***REMOVED***");
    ...
    public async Task Blazor_yonlendirmeleri_degismedi()
    {
        ...
        {
            ["firma"] = "yucerent", ["kullanici"] = "umit", ["sifre"] = "***REMOVED***",
        }));
        Assert.Equal(HttpStatusCode.Redirect, giris.StatusCode);
