...
/// <summary>
/// PR4c — ComputeGun canlı referans sistem kalibrasyonu: 24h tam blok + ~3sa kısmi eşiği (eski ceil DEĞİL).
/// BAĞIMSIZ ORACLE: beklenen günler referans sistem gün-hesabı tablosundan (elle), eşik-uzağı senaryolarla.
/// Birim test (DB yok).
/// </summary>
