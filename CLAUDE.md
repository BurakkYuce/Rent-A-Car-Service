# CLAUDE.md — RentACar (referans sistem fonksiyonel klonu)
...
2. **Canlı referans sistem kuruş-kalibrasyonu** — fiyat motoru oranlarının canlı sistemle birebir doğrulanması (çerez erişimi mevcut, bkz. memory).
