...
/// <summary>
/// Kiralama kuralı / promosyon-kampanya (canlı referans sistem kiralama_kurallari + kiralama_sartlari +
...
public class RentalRule : ITenantOwned, IAuditable, IBranchScoped
{
    ...
    /// DEĞİŞTİRMEZ (bkz. <see cref="RuleDateType"/>).</summary>
    ...
    /// <see cref="CampaignStatus.Aktif"/> kuralları okur.
    ...
    /// </summary>
    public CampaignStatus KampanyaDurum { get; set; } = CampaignStatus.Aktif;
