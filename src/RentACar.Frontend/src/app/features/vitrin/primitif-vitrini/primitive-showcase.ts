...
import { PathComponents } from './path-components';

const VIEWS = ['Liste', 'Kart', 'Takvim'] as const;
...
@Component({
  ...
  imports: [RouterLink, EmptyState, Icon, PathComponents],
  ...
  template: `
    ...
    <section class="rc-bolum" aria-labelledby="dugmeler">
      ...
      <div class="rc-dugme-grubu" role="group" aria-label="Görünüm">
        @for (secenek of views; track secenek) {
          <button
            type="button"
...
export class PrimitiveShowcase {
  protected readonly views = VIEWS;
  protected readonly gorunum = signal<View>('Liste');
