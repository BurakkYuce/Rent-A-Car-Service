...
const STATUSES = ['basari', 'uyari', 'hata', 'bilgi', 'notr'] as const;

/** Ham palet aileleri (`--rc-ham-{aile}-{ton}`); bileşen stilinde doğrudan okunmaz. */
const RAW_PALETTE: readonly RenkGrubu[] = [
...
const STATUS_DICTIONARY: readonly DurumOrnegi[] = [
...
@Component({
  ...
  template: `
    ...
    @for (grup of colorGroups; track grup.ad) {
    ...
    <section class="rc-bolum" aria-labelledby="durum-sozlugu">
      ...
      <ul class="izgara">
        @for (durum of statusDictionary; track durum.ad) {
          <li
            class="durum"
    ...
    <section class="rc-bolum" aria-labelledby="durum-renkleri">
      ...
      <ul class="izgara">
        @for (durum of statuses; track durum) {
          <li
            class="kutu"
    ...
    @for (grup of rawPalette; track grup.ad) {
    ...
    <section class="rc-bolum" aria-labelledby="yazi-olcegi">
      ...
      @for (adim of typeScale; track adim) {
      ...
      <p class="yazi">
        @for (agirlik of weights; track agirlik) {
    ...
    <section class="rc-bolum" aria-labelledby="bosluk-olcegi">
      ...
      <ul class="izgara">
        @for (adim of spacings; track adim) {
          <li>
...
export class TokensShowcase {
  protected readonly colorGroups: readonly RenkGrubu[] = [
    {
      ad: 'Zemin ve yüzey',
  ...
  protected readonly rawPalette = RAW_PALETTE;
  protected readonly statusDictionary = STATUS_DICTIONARY;
  protected readonly statuses = STATUSES;
  protected readonly typeScale = ['2xs', 'xs', 'sm', 'md', 'lg', 'xl', '2xl', '3xl'] as const;
  protected readonly weights = ['normal', 'orta', 'kalin', 'cok-kalin'] as const;
  protected readonly spacings = ['0-5', '1', '1-5', '2', '3', '4', '5', '6', '8', '12'] as const;
  protected readonly radii = ['sm', 'md', 'lg', 'xl', 'tam'] as const;
  protected readonly shadows = ['1', '2', '3', 'katman'] as const;
}
