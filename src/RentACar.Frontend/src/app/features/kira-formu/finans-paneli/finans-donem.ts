...
import type { HesapTuru, KiraDonem } from './finans-tipleri';
                  ...
                  @if (d.durum === 'Planlandi' && f.finans() && !f.iptal()) {
                    ...
                    <div class="kf-finans__satir" [formGroup]="df">
                      ...
                      <button
                        ...
                        [disabled]="f.donemKilidi.gonderiliyor()"
                        (click)="f.donemKes(d)"
                      >
                        {{
                          (f.gonderilenDonem() === sira(d)
                            ? 'form.gonderiliyor'
...
export class FinansDonem {
  protected readonly f = inject(KiraFinansDurumu);
  protected readonly para = paraGoster;
  protected readonly sira = (d: KiraDonem): number => Number(d.donemSira);
