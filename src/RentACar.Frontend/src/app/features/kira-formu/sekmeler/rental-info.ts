  ...
  template: `
          ...
          <div class="kf-bilgi">
            ...
            <strong>{{
              d.yeni
                ...
                : (d.visibleDetail()?.islemSubeAdi ?? ('kiraFormu.alan.subeEslenmemis' | transloco))
            }}</strong>
          </div>
        </div>
      </section>
      ...
      <section class="rc-bolum kf-kart">
        ...
        <div class="rc-form-izgara">
          ...
          <rc-alan [etiket]="'kiraFormu.alan.fazlaKmUcret' | transloco">
            <rc-para-girdisi formControlName="fazlaKmUcret" [paraBirimi]="d.rentalCurrency()" />
          </rc-alan>
          <rc-alan [etiket]="'kiraFormu.alan.yakitBirimUcret' | transloco">
            <rc-para-girdisi formControlName="yakitBirimUcret" [paraBirimi]="d.rentalCurrency()" />
          </rc-alan>
        </div>
        <p class="kf-not">
      ...
      <section class="rc-bolum kf-kart">
        ...
        <div class="rc-form-izgara">
          <rc-alan [etiket]="'kiraFormu.alan.opsiyonNet' | transloco">
            <rc-para-girdisi formControlName="opsiyonNet" [paraBirimi]="d.rentalCurrency()" />
          </rc-alan>
    ...
    <section class="rc-bolum kf-kart">
      ...
      @if (d.kirada() && !d.delivered()) {
        <div class="rc-form-izgara" [formGroup]="d.deliveryForm" data-testid="teslim-formu">
          ...
          <div class="kf-eylemler">
            <button
              ...
              [disabled]="!d.operasyon() || d.deliverySubmission.gonderiliyor()"
              (click)="d.deliver()"
            >
        ...
        <rc-form-hatalari [hatalar]="d.deliverySubmission.genelHatalar()" />
      } @else {
      ...
      @if (!d.yeni) {
        <div class="rc-form-izgara" [formGroup]="d.form">
          <rc-alan [etiket]="'kiraFormu.alan.teslimEden' | transloco">
            <rc-arama-secim formControlName="teslimEdenPersonel" [kaynak]="d.staffDataSource" />
          </rc-alan>
        </div>
      }
    </section>
