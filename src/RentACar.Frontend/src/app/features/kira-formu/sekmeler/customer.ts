    ...
    <div [formGroup]="d.form">
      <section class="rc-bolum kf-kart">
        ...
        <div class="rc-form-izgara">
          ...
          >
            <rc-arama-secim formControlName="musteri" [kaynak]="d.customerDataSource" />
          </rc-alan>
      ...
      } @else if (d.customerSummary.tur() === 'hata') {
        ...
        <div class="rc-form-izgara">
          ...
          @if (ozet(); as m) {
            ...
            >
              ...
              <strong data-testid="risk-limiti">{{ count(m.riskLimiti) | para }}</strong>
            </div>
          }
          @if (d.isRiskApprovalVisible()) {
...
export class Customer {
  ...
  protected readonly ozet = computed(() =>
    this.d.yeni ? null : (this.d.customerSummary.veri() ?? null),
  );
