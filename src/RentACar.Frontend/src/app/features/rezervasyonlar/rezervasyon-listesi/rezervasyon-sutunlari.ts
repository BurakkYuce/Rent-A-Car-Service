...
import { sayiya, type RezervasyonListeSatiri } from '../rezervasyon-modeli';
 ...
 */
export function rezervasyonSutunlari(t: Ceviri): readonly TabloSutunu<RezervasyonListeSatiri>[] {
  const s = (kod: RezervasyonSutunu) => t(`rezervasyon.sutun.${kod}`);
  return [
