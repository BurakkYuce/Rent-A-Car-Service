...
public static class TenantGun
{
    ...
    public static DateOnly Gun(DateTimeOffset an, TimeZoneInfo? tz = null)
        => DateOnly.FromDateTime(TimeZoneInfo.ConvertTime(an, tz ?? Dilim).DateTime);
}
