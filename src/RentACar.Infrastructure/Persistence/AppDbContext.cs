...
public sealed class AppDbContext : DbContext
{
    ...
    public DbSet<TalepNotu> TalepNotlari => Set<TalepNotu>();         // PR-17 talep takip geçmişi
    ...
    public DbSet<MusteriTaksit> MusteriTaksitleri => Set<MusteriTaksit>();     // FAZ-66 — müşteri taksit takibi
