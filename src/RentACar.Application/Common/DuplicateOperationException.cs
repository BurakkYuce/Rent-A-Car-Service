...
/// </summary>
public sealed class DuplicateOperationException(string message, MevcutIslem? existing = null) : ValidationException(message)
{
    /// <summary>
    ...
    /// </summary>
    public MevcutIslem? Existing { get; } = existing;
    ...
    public const string DifferentContentMessage =
    ...
    public static DuplicateOperationException DifferentContent() => new(DifferentContentMessage);
}
