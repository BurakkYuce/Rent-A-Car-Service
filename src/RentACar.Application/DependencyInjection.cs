...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<RentACar.Application.Finance.BakiyeDuzeltmeService>();  // FAZ-56
        ...
        services.AddScoped<Integrations.BildirimKanaliService>(); // bildirim omurgası: tenant SMTP/SMS
        services.AddScoped<Notifications.MusteriBildirimService>(); // müşteriye giden bildirim (şablon + idempotent kayıt)
        ...
        services.AddScoped<TenantSettings.FormVarsayilanCozucu>(); // FAZ-82 form ön-doldurma varsayılanları (admin-gate atlar)
        ...
        services.AddScoped<TabloDuzenleri.TabloDuzeniService>(); // F3.5 kişisel tablo düzeni
