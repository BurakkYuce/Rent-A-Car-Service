...
public interface IVehicleGroupRepository
{
    ...
    Task<bool> AdExistsAsync(string ad, Guid? excludeId = null, CancellationToken ct = default);
    ...
    Task<int> GrupDegeriTasiAsync(string? kaynakDeger, bool bosOlanlar, string hedefAd, CancellationToken ct = default);
