...
/// <summary>
/// Yakıt türü master tanımı — <see cref="MasterDefinitionService{T}"/> ince alt sınıfı (O12d): doğrulama,
...
public sealed class FuelKindService(IFuelKindRepository repository, ICurrentUser currentUser, ITenantCache cache)
    : MasterDefinitionService<FuelKind>(repository, currentUser, cache, "fuel-kinds", "yakıt türü")
{
