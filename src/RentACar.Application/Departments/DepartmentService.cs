...
/// <summary>
/// Departman master tanımı — <see cref="MasterDefinitionService{T}"/> ince alt sınıfı (O12d): doğrulama,
...
public sealed class DepartmentService(IDepartmentRepository repository, ICurrentUser currentUser, ITenantCache cache)
    : MasterDefinitionService<Department>(repository, currentUser, cache, "departments", "departman")
{
