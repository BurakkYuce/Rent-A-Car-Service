...
public sealed class PeriodLockService(
    IPeriodLockRepository repository, ICurrentUser currentUser, Authorization.ScreenPermissionService screens) : IPeriodLockGuard
{
    private readonly IPeriodLockRepository _repository = repository;
    ...
    public async Task LockAsync(DateTimeOffset closingDate, CancellationToken ct = default)
    {
