...
/// </summary>
public static class BelgeSablonVarsayilan
{
    public const string SozlesmeBaslik = "ARAÇ TESLİM BELGESİ / RENTAL AGREEMENT";

    public const string SozlesmeHukukiSol =
    ...
    public const string SozlesmeHukukiSag =
    ...
    public const string FaturaBaslik = "FATURA";
}
