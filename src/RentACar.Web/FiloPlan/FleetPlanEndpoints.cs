...
public static class FleetPlanEndpoints
{
    public static IEndpointRouteBuilder MapFleetPlanEndpoints(this IEndpointRouteBuilder app)
    {
    ...
    {
        try { await action(); return Result.Ok("/filo-plan", message); }
