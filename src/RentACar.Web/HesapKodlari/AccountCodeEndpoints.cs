...
public static class AccountCodeEndpoints
{
    public static IEndpointRouteBuilder MapAccountCodeEndpoints(this IEndpointRouteBuilder app)
    {
    ...
    {
        try { await action(); return Result.Ok("/hesap-kodlari", message); }
