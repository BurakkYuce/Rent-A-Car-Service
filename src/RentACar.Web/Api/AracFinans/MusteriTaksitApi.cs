...
public static partial class MusteriTaksitApi
{
    ...
    private static readonly SortFieldMap<MusteriTaksitSatiri> Harita = SortFieldMap<MusteriTaksitSatiri>
        .Create(t => t.Id)
    ...
    private static async Task<List<MusteriTaksit>> KumeAsync(CustomerInstallmentService svc, IDbContextFactory<AppDbContext> dbf,
        ...
        bool? gecikmis, CancellationToken ct)
    {
        ...
        {
            CariId = cariId, VehicleId = vehicleId, Durum = F5Ortak.EnumAdi<InstallmentStatus>(durum, "durum"),
    ...
    private static async Task<MusteriTaksit?> KapsamliAsync(Guid id, CustomerInstallmentService svc,
