    ...
    private static void MapAccountDefinitions(RouteGroupBuilder v1)
        => v1.MapDefinition(new DefinitionRoute<FinancialAccount, FinancialAccountDto, FinancialAccountRequest>
        {
            ...
            ValidateLimits = r =>
            {
                ...
                Sinirlar.Metin(r.Tur, 32, "tur", "Tür");
                Sinirlar.Metin(r.Iban, 34, "iban", "IBAN");
                Sinirlar.Metin(r.HesapNo, 64, "hesapNo", "Hesap no");
                Sinirlar.Metin(r.Banka, 128, "banka", "Banka");
                Sinirlar.Metin(r.Sube, 128, "sube", "Şube");
                Sinirlar.Metin(r.OzelKod, 32, "ozelKod", "Özel kod");
                Sinirlar.Metin(r.UyariMailListesi, 512, "uyariMailListesi", "Uyarı mail listesi");
            },
            FieldRules =
            [
