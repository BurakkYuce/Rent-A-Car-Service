...
/// <summary>Kod + Ad + Aktif definition row (every <see cref="MasterTanimService{T}"/> table).</summary>
...
/// <summary>
/// F11.1a — <see cref="DefinitionRoute{TEntity,TDto,TRequest}"/> factory for the <see cref="MasterTanimService{T}"/>
...
public static class MasterDefinitions
{
    ...
    public static readonly SiralamaHaritasi<DefinitionDto> Sort = SiralamaHaritasi<DefinitionDto>
    ...
    public static DefinitionRoute<T, DefinitionDto, DefinitionRequest> For<T, TService>(
        ...
        where TService : MasterTanimService<T>
    {
    ...
    private static TService S<T, TService>(IServiceProvider sp) where T : class, IMasterTanim, new() where TService : MasterTanimService<T>
