...
/// </summary>
public sealed class RentalFormVm
{
    ...
    public string QMusteriGoruntu =>
        QMusteriId is Guid q && Customers.FirstOrDefault(c => c.Id == q) is { } m ? CustomerDisplay(m) : "";
    ...
    public static readonly string[] RentalTypes = ["Kısa Kiralama", "Uzun Kiralama", "İkame", "Aylık"];
    public static readonly string[] InvoicingTypes = ["Müşteri Ödemeli", "Full Credit", "Extralar Müşteriye Ait", "Drop Dahil", "Diğer"];
    ...
    public static readonly string[] PriceTypes = RentACar.Application.Pricing.PriceTypeOption.All;
    public static readonly string[] Currencies = ["TL", "EURO", "USD"];
    ...
    public static string CustomerDisplay(Customer c) => $"{c.DisplayName} · #{c.Id.ToString()[..8]}";
    public static string VehicleDisplay(Vehicle v) => $"{v.Plaka} · {v.Marka} {v.Tip} · #{v.Id.ToString()[..8]}";
}
