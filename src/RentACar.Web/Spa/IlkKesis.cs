...
///
/// <para><b>Yönlendirme haritası</b> (<see cref="Harita"/>): kesişi yapılmış fazların (F4, F5, F6, F7, F10, F11) envanterinde
...
public static class IlkKesis
{
    ...
    /// <c>/tarife-aktar</c> F11'in sayfası değil, haritada yok.</item>
    /// </list>
    /// </summary>
