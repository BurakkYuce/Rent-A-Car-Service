...
/// </summary>
public static class ExportTarih
{
    /// <summary>
    ...
    /// </param>
    public static string? Gun(DateTimeOffset? d, TimeZoneInfo? tz = null)
    ...
    public static DateTime Hucre(DateTimeOffset d, TimeZoneInfo? tz = null)
