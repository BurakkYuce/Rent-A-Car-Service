...
public static class AssistansTalepEndpoints
{
    public static IEndpointRouteBuilder MapAssistansTalepEndpoints(this IEndpointRouteBuilder app)
    {
    ...
    private static string Geri(HttpRequest req, string? hata = null)
    {
        ...
        foreach (var ad in new[] { "plakaF", "min", "max", "ara", "durum" })
        {
