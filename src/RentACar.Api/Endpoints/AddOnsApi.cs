...
public static class AddOnsApi
{
    public static IEndpointRouteBuilder MapAddOnsApi(this IEndpointRouteBuilder app)
    {
        ...
        grp.MapPost("/", async (AddOnDefinitionRequest req, AddOnDefinitionService svc, CancellationToken ct) =>
        {
        ...
        grp.MapPut("/{id:guid}", async (Guid id, AddOnDefinitionRequest req, AddOnDefinitionService svc, CancellationToken ct) =>
